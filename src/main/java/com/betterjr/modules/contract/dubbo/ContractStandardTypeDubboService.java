...
public class ContractStandardTypeDubboService implements IContractStandardTypeService {
    ...
    public String webContractStandards(Map<String, Object> anMap) {
        ...
        return AjaxObject
                .newOk("标准合同登记成功！", contractStandardTypeService.addContractStandards(anMap, contractStandardType))
                .toJson();
    }
    ...
    public String webSaveModifyContractType(Map<String, Object> anMap, Long id) {
        ...
        ContractStandardType contractStandardType = RuleServiceDubboFilterInvoker.getInputObj();
        return AjaxObject
                .newOk("标准合同类型编辑成功！", contractStandardTypeService.saveModifyContractType(contractStandardType, id))
                .toJson();
    }
    ...
    public String webQueryUnEnableContractStandardType(int anPageNum, int anPageSize, String anFlag) {
        // TODO Auto-generated method stub
        return AjaxObject
                .newOkWithPage("查询未启用标准合同类型成功！",
                        contractStandardTypeService.queryUnEnableContractStandardType(anPageNum, anPageSize, anFlag))
                .toJson();
    ...
    public String webQueryContractStandardType(int anPageNum, int anPageSize, String anFlag) {
        // TODO Auto-generated method stub
        return AjaxObject.newOkWithPage("查询已启用标准合同成功！",
                contractStandardTypeService.queryContractStandardtType(anPageNum, anPageSize, anFlag)).toJson();
    }
    ...
    @Override
    public String webQueryAllContractStandardType(Map<String, Object> anMap, int anPageNum, int anPageSize,
            String anFlag) {
        // TODO Auto-generated method stub
        return AjaxObject
                .newOkWithPage("启用合标准同类型成功！",
                        contractStandardTypeService.queryAllContractStandardTyp(anMap, anPageNum, anPageSize, anFlag))
                .toJson();
