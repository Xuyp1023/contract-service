...
public class ContractTemplateDubboService implements IContractTemplateService {
     ...
     */
    @Override
    public String webQueryTemplate(final Map<String, Object> anParam, final int anFlag, final int anPageNum, final int anPageSize) {
        final Map<String, Object> param = RuleServiceDubboFilterInvoker.getInputObj();
     ...
     */
    @Override
    public String webQueryAuditTemplate(final Map<String, Object> anParam, final int anFlag, final int anPageNum, final int anPageSize) {
        final Map<String, Object> param = RuleServiceDubboFilterInvoker.getInputObj();
